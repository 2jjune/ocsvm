...
def video_generator(directory):
    ...
    for label in labels:
        ...
        for video_file in os.listdir(label_dir):
            ...
            # Extend the frames to have a fixed length
...
# (train_dataset, y_train), (val_dataset, y_test) = keras.datasets.cifar100.load_data()
...
def run_experiment(model):
    ...
    # _, accuracy, top_5_accuracy = model.evaluate(val_dataset, y_test)
